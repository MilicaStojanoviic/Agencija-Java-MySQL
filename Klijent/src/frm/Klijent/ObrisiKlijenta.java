 ...
 * @author Lenovo
 */
public class ObrisiKlijenta extends javax.swing.JDialog {

    private Klijent k;
    
    public ObrisiKlijenta(JDialog parent, boolean modal, Klijent k) {
        super(parent, modal);
        initComponents();
        this.k = k;
        ...
        txtTipKlijenta.setEditable(false);
    ...
    private void btnObrisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnObrisiActionPerformed
        ...
        if (result == JOptionPane.YES_OPTION) {
            try {
                Komunikacija.getInstance().deleteKlijent(k);
